...
$(document).ready(function () {
    ...
    getPhysiciansAndShow();

    function getPhysiciansAndShow() {
        $.ajax({
            url: '/admin/GetPhysicianLocation',
            type: 'GET',
    ...
    function plotPhysicianLocations(locations) {
        locations.forEach(function (location) {

            console.log(location)
            createMarker([location.longtitude, location.latitude], '#120b74', location.physicianname, location);
...
function createMarker(position, color, popupText, physicianData) {
...
function populateModal(physicianData) {
    $('#physicianName').text(physicianData.physicianname);
